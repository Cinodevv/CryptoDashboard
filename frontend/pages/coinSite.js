...
const DuckSite = () => {
  ...
  const goToContract = () => {
    try {
      window.location.href =
        "https://bscscan.com/address/0x3b7d1865c72bb955d523bd39ba85cb290827c451";
    } catch (err) {
      setError(err.message);
      console.log(err.message);
    }
  ...
  const goToTokeninfo = () => {
    try {
      window.location.href =
        "https://bscscan.com/token/0x3b7d1865c72bb955d523bd39ba85cb290827c451";
    } catch (err) {
      setError(err.message);
      console.log(err.message);
    }
  ...
  const goToOpensea = () => {
    try {
      window.location.href =
        "https://testnets.opensea.io/collection/cryptoducks-m2yxnlizh9";
    } catch (err) {
      setError(err.message);
      console.log(err.message);
    }
  ...
  return (
    <body className={styles.bodyPage}>
      <div>
        ...
        <button onClick={goToPoocoin} className={styles.theButton}>
          Buy{" "}
          <Image
        ...
        <ReactNbsp />
        <ReactNbsp />
        <button onClick={goToCake} className={styles.theButton}>
          Buy{" "}
          <Image
            className={styles.pancakeLogo}
            src="/pancakeSwap.jpg"
        ...
        <ReactNbsp />
        <ReactNbsp />
        <button onClick={goToContract} className={styles.theButton}>
          Contract{" "}
          <Image
            className={styles.pancakeLogo}
            src="/contract.png"
        ...
        <ReactNbsp />
        <ReactNbsp />
        <button onClick={goToOpensea} className={styles.theButton}>
          Opensea{" "}
          <Image
            className={styles.pancakeLogo}
            src="/osea.png"
        ...
        <ReactNbsp />
        <ReactNbsp />
        <button onClick={goToTokeninfo} className={styles.theButton}>
          Token{" "}
          <Image
            className={styles.pancakeLogo}
            src="/logo.png"
        ...
        <div className={styles.bottomPage}>
          ...
          <hr></hr>
          <button onClick={goToLanding} className={styles.theButton}>
            Return
          </button>
